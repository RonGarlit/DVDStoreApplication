...
***********************************************************************************
**
**  FileName: IEnumerableExtensions.cs (DVDStore Application)
**  Version: 0.1
**  Author: Ronald Garlit
**
**  Description: This file contains the IEnumerableExtensions class for the DVDStore web application.
**  
**  The IEnumerableExtensions class provides extension methods for enumerating data.
**
**  Change History
**
**  WHEN			WHO        WHAT
